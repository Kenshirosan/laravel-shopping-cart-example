...
Vue.component(
    'order-progress',
    require('./components/OrderProgress.vue').default
);
Vue.component(
    'monthly-stats',
    require('./components/MonthlyStats.vue').default
);
...
Vue.component(
    'order-notification',
    require('./components/OrderNotification').default
);
Vue.component(
    'global-order-notification',
    require('./components/GlobalOrderNotification').default
);
...
Vue.component(
    ...
    require('./components/TodaysSpecialSlider').default
);

Vue.component(
    'mark-as-today-special',
    require('./components/MarkAsTodaySpecial').default
);

Vue.component(
    'add-unique-coupons',
    require('./components/subcomponents/UniqueCoupons').default
);
Vue.component(
    'add-coupons-for-everyone',
    require('./components/subcomponents/CouponsForEveryone').default
);
Vue.component(
    'coupon-layout',
    require('./components/subcomponents/CouponLayout').default
);
